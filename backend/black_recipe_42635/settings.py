"""
Django settings for black_recipe_42635 project.
...
ROOT_URLCONF = 'black_recipe_42635.urls'
...
WSGI_APPLICATION = 'black_recipe_42635.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_recipe_42635 API",
    "DESCRIPTION": "API documentation for black_recipe_42635 App",
    "VERSION": "v1",
}
